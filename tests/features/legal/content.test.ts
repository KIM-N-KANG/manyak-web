...
describe('법적 문서 콘텐츠', () => {
  it('약관은 확정된 시행일·버전과 주요 조항을 갖는다', () => {
    ...
    expect(termsContent.effectiveDate).toBe('2026-09-19');
    expect(termsContent.version).toBe('v1.3');
  ...
  it('개인정보 처리방침은 확정된 시행일·버전과 법정 항목을 갖는다', () => {
    ...
    expect(privacyContent.effectiveDate).toBe('2026-09-19');
    expect(privacyContent.version).toBe('v1.5');
