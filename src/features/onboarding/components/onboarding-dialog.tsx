    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent
        ...
        <div
          ...
          <DialogHeader className="gap-4">
            ...
            <m.div {...fadeUp(0.08)}>
              <DialogDescription className="text-base text-foreground">
                키워드 몇 개를 고르면 AI가 스토리라인을 만들어드려요. 마음에
                드는 스토리라인을 골라 채팅으로 바로 이어갈 수 있습니다.
              </DialogDescription>
            </m.div>
          </DialogHeader>
          ...
          <m.div
            {...fadeUp(0.16)}
            className="mt-8 rounded-lg bg-muted px-4 py-3 text-base text-foreground-secondary">
            지금은{' '}
        ...
        <m.div
          {...fadeUp(0.24)}
          className="mx-auto w-full max-w-md px-4 pt-2 pb-[calc(1rem+env(safe-area-inset-bottom))]">
          <Button
            type="button"
            size="lg"
            className="w-full"
