...
| 바꾼 것                                                 | 갱신할 스펙 문서                              |
| ------------------------------------------------------- | --------------------------------------------- |
| 화면 구성·사용자 흐름·화면 상태·입력 검증·API 연동 계약 | `3-1-client-spec.md`                          |
| 웹 사용자 모델·URL·히스토리·브라우저·검색 노출 계약     | `3-2-web-spec.md`                             |
| BFF·세션·저장소·렌더·현재 내부 구조                     | `3-2-1-web-design.md`                         |
| 중요한 기술 선택과 이유                                 | `3-1-1-client-adr.md` 또는 `3-2-2-web-adr.md` |
...
- `4-backend.md`·`5-1-ai-server-spec.md`·`5-2-ai-server-adr.md`·`3-3-android-spec.md`·`3-3-1-android-design.md`·`3-3-2-android-adr.md`는 다른 팀원 소유이므로 웹 작업으로 수정하지 않습니다. 웹 변경이 백엔드·AI·앱 계약에 걸리면 문서를 고치지 말고 사용자에게 알리세요.
