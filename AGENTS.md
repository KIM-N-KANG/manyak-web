...
| 웹 사용자 모델·URL·히스토리·브라우저·검색 노출 계약     | `3-3-web-spec.md`                         |
| BFF·세션·저장소·렌더·현재 내부 구조                     | `3-4-web-design.md`                       |
| 중요한 기술 선택과 이유                                 | `3-2-client-adr.md` 또는 `3-5-web-adr.md` |
...
- `4-backend.md`·`5-1-ai-server-spec.md`·`5-2-ai-server-adr.md`·`3-6-android-spec.md`·`3-7-android-design.md`·`3-8-android-adr.md`는 다른 팀원 소유이므로 웹 작업으로 수정하지 않습니다. 웹 변경이 백엔드·AI·앱 계약에 걸리면 문서를 고치지 말고 사용자에게 알리세요.
